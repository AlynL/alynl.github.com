...
window.Typekit.config = {
  ...
  "dl": "AAAASAAAAAoTBllGA-5buAAAAJw",
  "fi": [175, 10304],
  "fc": [{
    "id": 175,
    "family": "proxima-nova",
    "src": "https://use.typekit.net/af/ba9aae/00000000000000003b9aec27/27/{format}{?primer,subset_id,fvd,v}",
    "descriptors": {
      "weight": "400",
      "style": "normal",
      "subset_id": 2
    ...
    "src": "https://use.typekit.net/af/6dab55/0000000000000000000132e5/27/{format}{?primer,subset_id,fvd,v}",
    "descriptors": {
      "weight": "900",
      "style": "normal",
      "subset_id": 2
  ...
  "fn": ["brandon-grotesque", ["n9"], "proxima-nova", ["n4"]],
  "hn": "use.typekit.net",
  "ht": "tk",
  "js": "1.18.23",
  "kt": "wbl1pcz",
      ...
      a.fontactive = function(a, b) {
        ...
        a: {
          ...
          for (var l = n.fc, p = 0; p < l.length; p++)
            if (l[p].family === a && l[p].descriptors.weight === h && l[p].descriptors.style === g) {
              g = l[p].id;
              break a
            }
          g = 0
